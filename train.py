...
def test(args, snd_opt):
    ...
    data_dir = args.data_dir
    ckpt_dir = args.ckpt_dir
    ckpt_dir = os.path.join(ckpt_dir,snd_opt)
    log_dir = args.log_dir
    result_dir = args.result_dir
    ...
    if mode == 'test':
        ...
        dataset_test_a = Dataset(data_dir=os.path.join(data_dir, 'example_captions'), transform=transform_test, task=task,
                                 data_type='a')
        ...
        dataset_test_b = Dataset(data_dir=os.path.join(data_dir, 'example_captions'), transform=transform_test, task=task,
                                 data_type='b')
