...
parser.add_argument("--data_dir", default="./models/bird_AttnGAN2", type=str, dest="data_dir")
parser.add_argument("--ckpt_dir", default="./checkpoint", type=str, dest="ckpt_dir")
parser.add_argument("--log_dir", default="./log", type=str, dest="log_dir")
parser.add_argument("--result_dir", default="./static/css/result", type=str, dest="result_dir")
